...
@TableAnnotation
public class PermDriver implements TypeModel{
	...
	public PermDriver(String username, String password, String name, long mobile, String email, char gender,
			String address) {
		super();
