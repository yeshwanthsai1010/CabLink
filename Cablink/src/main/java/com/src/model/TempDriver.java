...
@TableAnnotation
public class TempDriver implements TypeModel{
	...
	public TempDriver(String username, String password, String name, long mobile, String email, char gender,
			String address) {
		super();
